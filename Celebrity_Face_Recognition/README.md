...
Welcome to the **Celebrity Face Recognition** project! This directory contains the specific source code, resources, and implementation details for this project.
